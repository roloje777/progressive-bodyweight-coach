...
import { ActiveDeload, ActiveMaintenance, ActiveRepeatWeek, PendingGraduation } from "@/models/ProgramProgress";
...
export type ProgressState = {
  ...
  /** Explicit marker for an unlocked open-ended maintenance phase. */
