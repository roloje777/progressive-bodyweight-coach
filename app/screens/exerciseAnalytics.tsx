...
const createStyles = (palette: ReturnType<typeof useAppPalette>) => StyleSheet.create({
  ...
  effortRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: palette.surfaceAlt, paddingTop: 12, marginTop: 8 },
